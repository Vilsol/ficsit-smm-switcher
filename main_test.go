...
func TestIdentifyPlatformWindows(t *testing.T) {
	for _, ua := range windowsUA {
		t.Run(ua, func(t *testing.T) {
			testza.AssertEqual(t, Windows, identifyPlatform(ua))
		})
	}
}

func TestIdentifyPlatformLinux(t *testing.T) {
	for _, ua := range linuxUA {
		t.Run(ua, func(t *testing.T) {
			testza.AssertEqual(t, Linux, identifyPlatform(ua))
		})
	}
}

func TestIdentifyPlatformDarwin(t *testing.T) {
	for _, ua := range darwinUA {
		t.Run(ua, func(t *testing.T) {
			testza.AssertEqual(t, Darwin, identifyPlatform(ua))
		})
	}
}
